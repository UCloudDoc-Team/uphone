...
> 2）也可以过几个小时至一天再尝试登录
> 
> 3) 注册后不要退出再登录切换账号，尤其是gmail账号注册泛滥更容易被限制

### Q：TikTok养号有什么要注意的？
> 1）新账号注册后不要直接上传视频、不要大量关注点赞（容易被标记为营销号），冷却几天再像正常用户一样每天点击、上传2-3个优质视频
> 
> 2）目前使用gmail注册过于泛滥，使用手机号注册更容易获得流量，绑定insgram facebook 手机号（当地手机号更佳） 
> 
> 3) 所有原则就是像真实用户一样的行为，平台鼓励优质视频
